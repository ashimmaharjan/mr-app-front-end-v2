                        ...
                        <div>
                            ...
                            <div className="mt-8">
                                <div>
                                    ...
                                    <input type="text" name="username" onChange={handleChange("username")} className="w-full h-11 mt-1 shadow-sm rounded-full pl-3 border-none outline-none focus:ring-2" />
                                </div>

                                <div className="mt-3">
                                    <label htmlFor="Email or Username" className="ml-2">Password</label>
                                    <input type="password" name="password" onChange={handleChange("password")} className="w-full h-11 mt-1 shadow-sm rounded-full pl-3 border-none outline-none focus:ring-2" />
                                </div>
