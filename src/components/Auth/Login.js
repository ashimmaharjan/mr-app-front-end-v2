...
const Login = ({ history }) => {
  ...
  const loginForm = () => {
    return (
      ...
      >
        <div
          className="grid grid-cols-1 md:grid-cols-2 h-[500px] w-10/12
        ...
        >
          ...
          <form action="POST">
            <div
              className="col-span-1 h-full flex text-gray-500 flex-col justify-center items-center"
            ...
            >
              <div>
                ...
                <div className="mt-8">
                  <div>
                    <label htmlFor="Email or Username" className="ml-2">
                      Email or Username
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full h-11 mt-1 shadow-sm rounded-full pl-3 border-none outline-none focus:ring-2"
                    />
                  </div>
                  ...
                  <button
                    onClick={clickSubmit}
                    type="submit"
                    className="h-14 w-full py-2 mt-10 bg-blue-800 rounded-xl text-white shadow hover:shadow-xl cursor-pointer hover:bg-blue-900 transition-all duration-300 ease-in-out"
                  >
                    Login
  ...
  return (
    <div>
      ...
      {redirectUser()}
      {redirectToReferrer ? (
        <AlertMessage message={"Success"} severity={"error"} />
      ) : (
        ""
      )}
    </div>
